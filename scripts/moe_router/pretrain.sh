...
ROUTER_WARMUP_STEPS=${ROUTER_WARMUP_STEPS:-100}
ROUTER_BOOTSTRAP_STEPS=${ROUTER_BOOTSTRAP_STEPS:-100}
WARMUP_ROUTING_STRATEGY=${WARMUP_ROUTING_STRATEGY:-round_robin}
...
ROUTER_EXPERIMENT_ARGS="\
  ...
  --router_bootstrap_steps $ROUTER_BOOTSTRAP_STEPS \
